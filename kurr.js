...
kurr.send5ButImg(m.chat, Anu, ` BOT BY REUSHOST `, fatihgans, btn)
break
case 'listpc': {		
...
case 'group': case 'grup': {
                ...
                let buttons = [
                    ...
                    await kurr.sendButtonText(m.chat, buttons, `Mode Group`, '© Copyright By ReusHosting', m)
...
⭔QRIS ALL PAY/NOPREM :
https://telegra.ph/file/3a8696ca4f799e47b9de1.jpg
...
case 'bcgc': case 'bcgroup': {
                if (!isCreator) throw mess.owner
                if (!text) throw `Text mana?\n\nExample : ${prefix + command} REUS - BOTZ`
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                      ...
                      kurr.send5ButImg(i, txt, '© ReusHosting', global.thumb, btn)
                    }
